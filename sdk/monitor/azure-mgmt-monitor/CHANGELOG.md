...
### Other Changes
  ...
  - Deleted model `AzureResource`/`AzureResourceAutoGenerated`/`CategoryType`/`DataCollectionEndpointResourceSystemData`/`DataCollectionRuleAssociationProxyOnlyResourceSystemData`/`DataCollectionRuleResourceSystemData`/`DataContainer`/`DataStatus`/`DiagnosticSettingsCategoryResource`/`DiagnosticSettingsResource`/`Error`/`ErrorDetailAutoGenerated2`/`ErrorResponseAutoGenerated2`/`ErrorResponseAutoGenerated3`/`ErrorResponseAutoGenerated4`/`ErrorResponseAutoGenerated5`/`OnboardingStatus`/`Operation`/`OperationDisplay`/`ResourceAutoGenerated`/`ResourceAutoGenerated2`/`ResponseWithError`/`VMInsightsOnboardingStatus`/`WorkspaceInfo` which actually were not used by SDK users
